 ...
 */
function getRadioValue({ form, controlName }) {
 ...
 */
function getCheckboxValue({ form, controlName }) {
 ...
 */
function getFiles({ form, controlName }) {
  const fileInput = form.querySelector(`[data-control-name=${controlName}]`);
 ...
 */
export function generateValue({ field, form }) {
